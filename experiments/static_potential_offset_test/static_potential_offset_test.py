...
def single_waveform(Gain_Error_Analysis=False, Gain_Error=1.0):
...
if __name__ == "__main__":
    ...
    with open('gea.txt') as gea:
        GEA = bool(gea.readline())
        GE = float(gea.readline())

    case_num = single_waveform(Gain_Error_Analysis=GEA, Gain_Error=GE)
