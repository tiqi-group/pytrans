...
def vSet_axial(curv):
    ...
    volt_axial = [
        ...
        -0.25685, 0, 0, 0, 0, 0.34665, 0.34665, -1.6753, 0.34665, 0.34665, 0,
        0, 0, 0, 0
    ]
...
def vSet_tilt(tilt):
    ...
    volt_tilt = [
        0.11526, 0, 0, 0, 0, 0, -0.28313, 0.013373, -0.28313, 0, -0.11526, 0,
        0, 0, 0, 0, 0.28313, -0.013373, 0.28313, 0, 0, 0, 0, 0, 0
    ]
...
def vSet_xComp(xComp):
    ...
    volt_xComp = [
        0, 0, 0, 0, 0, 0, -0.025833, 0, 0.025833, 0, 0, 0, 0, 0, 0, 0,
        -0.025833, 0, 0.025833, 0, 0, 0, 0, 0, 0
    ]
...
def vSet_yComp(yComp):
    ...
    volt_yComp = [
        0, 0, 0, 0, 0, 0, 0.06717, 0.06717, 0.06717, 0, 0, 0, 0, 0, 0, 0,
        -0.06717, -0.06717, -0.06717, 0, 0, 0, 0, 0, 0
    ]
...
def vSet_zComp(zComp):
    ...
    # Assuming 3 MHz radial frequency
    volt_zComp = [
        0.018312, 0, 0, 0, 0, 0, 0.11655, 0.042762, 0.11655, 0, 0.018312, 0, 0,
        0, 0, 0, 0.11655, 0.042762, 0.11655, 0, 0, 0, 0, 0, 0
    ]
...
def vSet_xCubic(xCubic):
    ...
    volt_xCubic = [
        0, 0, 0, 0, 0, -0.000492, 0.000189, 0, -0.000189, 0.000492, 0, 0, 0, 0,
        0, -0.000492, 0.000189, 0, -0.000189, 0.000492, 0, 0, 0, 0, 0
    ]
...
def vSet_xyTilt(xyTilt):
    ...
    volt_xyTilt = [
        0, 0, 0, 0, 0, -4.2, -4.2, 0, 4.2, 4.2, 0, 0, 0, 0, 0, 4.2, 4.2, 0,
        -4.2, -4.2, 0, 0, 0, 0, 0
    ]
...
def vSet_xzTilt(xzTilt):
    ...
    volt_xzTilt = [
        -0.20171, 0, 0, 0, 0, 8.2589, 8.2589, 0, -10.536, -10.536, -0.1445, 0,
        0, 0, 4.7086, -116.51, 30.483, 0, -36.9, 127.72, 0, 0, 0, 0, 0
    ]
...
def calculate_voltage(curv,
    ...
    voltages = (voltages + vSet_axial(curv) + vSet_tilt(tilt) +
                vSet_xComp(xComp) + vSet_yComp(yComp) + vSet_zComp(zComp) +
                vSet_xCubic(xCubic) + vSet_mesh(vMesh) + vSet_gnd(vGND) +
                vSet_xyTilt(xyTilt) + vSet_xzTilt(xzTilt))
